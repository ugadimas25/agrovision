...
async function main() {
  ...
  // Komponen RAB lebih dulu: uji impor Excel membuat baris yang menunjuk
  // kategori uji TEST%, dan FK budget_plan_items_cost_category_id_fkey menahan
  // penghapusan kategorinya. Tanpa urutan ini, pembersihan gagal dan RUN
  // BERIKUTNYA memulai dengan sisa data run sebelumnya -- kegagalan yang muncul
  // sebagai uji lain yang aneh, jauh dari sebabnya.
