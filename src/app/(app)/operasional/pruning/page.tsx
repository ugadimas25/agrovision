...
import { createPruningAction, updateOpRecordAction } from "@/lib/actions/operational";
...
export default async function Page() {
  ...
  return (
    <div>
      ...
      {ready && (
        <div className="mb-5">
          <OpRecordForm title="Catat pruning" action={createPruningAction} fields={fields} />
        </div>
      )}
      <OpRecordTable
        rows={rows.rows} moduleKey="pruning_records" emptyIcon={Scissors}
        emptyTitle="Belum ada catatan pruning" canWrite={canWrite}
